...
- **Resume:** [View PDF](https://github.com/sreekanth-ai/ds_sreekanth/blob/main/Data%20Scientist%20Resume.pdf)

---

## 🏆 Achievements
- Completed internships at **Unified Mentor (ML Intern)**, **Adverk (AI Intern)**, and **CodingClub (Python Mentor)**.
- Taught Python to over 50 students during my internship at CodingClub.
- Developed and deployed multiple ML web applications using **Flask** and **Streamlit**.
...
- **Concepts:** Machine Learning, Data Visualization, Regression, Classification, Model Deployment  
- **Tools:** GitHub, VS Code, Jupyter Notebook, Excel  
...
© 2025 Sreekanth Reddy Polu | Data Science & ML Engineer
